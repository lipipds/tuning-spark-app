...
def main():
    ...
    # TODO write in parquet
    df_total_trip_time.write.mode("overwrite").partitionBy("PU_Borough").parquet("./storage/rides/parquet/total_trip_time")
    df_hvfhs_license_num.write.mode("overwrite").partitionBy("hvfhs_license_num").parquet("./storage/rides/parquet/hvfhs_license_num")
